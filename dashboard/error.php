...
<html>
	...
	<!--
		...
		* Availability: https://freefrontend.com/html-css-404-page-templates/
	...
	<body>
		...
		<div class="error">
		  ...
		  <button class="error__button error__button--active" onclick="location.href='dashboard.php'">HOME</button>
		  <button class="error__button" onclick="location.href='help.php'">HELP</button>
		</div>
